...
2. NEVER use multiline strings inside JSON
3. ALWAYS escape newlines using \\n
4. ALWAYS escape quotes using \\\"
5. The value of "contents" MUST be a single-line string

Correct format example:

{
  "text": "Express server structure",
  "fileTree": {
    "app.js": {
      "file": {
